export const OBSERVED_FEATURES_PLOT_BACKEND_DATA_MOCK = {
  fig_aes: {
    ...
    bar_centers: [
      12232.77, 16482.51, 20732.25, 24981.989999999998, 29231.73, 33481.47,
      37731.21, 41980.95, 46230.69, 50480.43,
    ],
    years: {
      2011: {
        focal_value: 27920.0,
...
export const COUNT_HIST_DATA = {
  fig_aes: {
    ...
    bar_centers: [
      1431.045, 4293.135, 7155.225, 10017.315, 12879.405, 15741.495, 18603.585,
      21465.675000000003, 24327.765, 27189.855000000003,
    ],
    focal_display: 'None',
  },
  years: {

...
def get_distribution_prediction_plot2(data, geoid=None):
    ...
    fig.add_annotation(x=30,
                       ...
                       showarrow=False,
                       font={'size': 20, 'color': "black", 'family': 'Roboto'},
                       bordercolor="black",
                       borderwidth=2,
                       borderpad=4,
                       bgcolor=_low_risk_color,
                       opacity=1)

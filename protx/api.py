...
_MALTREATMENT_PLOT = api.model('MaltreatmentPlot', {
    "area": fields.String(),
...
class Resources(Resource):          # Should this be: Download(Resource)
        ...
        with engine.connect() as connection:
            ...
            for variable_info in display_data:
                ...
                for boolean_var_key in [
                    ...
                    var[boolean_var_key] = True if (
                        current_value == 1 or current_value == "1"
                    ) else False
                result.append(var)
